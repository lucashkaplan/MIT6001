...
class SubMessage(object):
    ...
    def __init__(self, text):
        ...
        The SubMessage class has one class variable:
            SubMessage.valid_words (list): list containing all valid words, determined using helper function load_words
        '''
...
class EncryptedSubMessage(SubMessage):
    ...
    def validWordCounter(self, decodedText):
        '''
    ...
    def decrypt_message(self):
        ...
        # if no good permutations exist, return original string
        if maxValidWords == 0:
            return self.message_text 
...
if __name__ == '__main__':
    ...
    # Test Case 3 - Expected decryption should be same as input string
    print("\nSubMessage class test case 3.")
    enc_message = EncryptedSubMessage("fifh idksm popq")
